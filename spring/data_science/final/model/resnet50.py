...
class ResNet50(nn.Module):
    ...
    def __init__(self, use_cbam=True, image_depth=3, num_classes=[16,77, 1000]):
        ...
        self.softmax_leaf = nn.Linear(num_classes[0] + num_classes[1] + num_classes[2], num_classes[2])
    ...
    def forward(self, x):
        ...
        level_3 = self.softmax_leaf(torch.cat((level_1, level_2,self.linear_lvl3(x)), dim=1))
